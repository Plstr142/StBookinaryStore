    ...
    return (
        <>
            ...
            <section className="text-right font-semibold text-gray-500">
                © 2025 Admin Dashboard. Built with {""}
                <a href="https://tailwindcss.com/" className="text-black hover:underline">Tailwind Css</a> |
                <a href="#" className="text-black hover:underline">Terms</a> |
                <a href="#" className="text-black hover:underline">Privacy</a>
            </section>
        </>
    )
}
