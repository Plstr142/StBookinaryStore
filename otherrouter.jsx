...
// import { routeDefs } from "./routeDefs.js";
...
<section className="flex md:bg-gray-100 min-h-screen overflow-hidden">
    <aside className="hidden sm:flex sm:flex-col">
        ...
        <Link href="/" className="flex items-center">
            <img src="/logoipsum-custom-logo.svg" alt="Logo" className="inline-flex items-center justify-center h-20 w-30" />
        </Link>
        <div className="flex-grow flex flex-col justify-between text-gray-500 bg-gray-800">
            <nav className="flex flex-col mx-4 my-6 space-y-4">
                ...
                <Link to="#" className="inline-flex items-center justify-center py-3 text-black bg-white rounded-lg">
            ...
            <div className="flex flex-shrink-0 items-center ml-auto">
                <button className="inline-flex items-center p-2 hover:bg-gray-100 focus:bg-gray-100 rounded-lg">
                    ...
                    <div className="hidden md:flex md:flex-col md:items-end md:leading-tight">
                        <span className="font-semibold">Mikael Nyström</span>
                        <span className="text-sm text-gray-600">Admin</span>
                    </div>
                    <span className="h-12 w-12 ml-2 sm:ml-3 mr-2 bg-gray-100 rounded-full overflow-hidden">
                        <img src="https://randomuser.me/api/portraits/men/42.jpg" alt="user profile photo" className="h-full w-full object-cover" />
                    </span>
